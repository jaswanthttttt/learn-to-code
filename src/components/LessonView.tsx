      ...
      <div className="mt-5 space-y-4">
        {lesson.blocks.map((b, i) => {
          ...
          if (b.type === "code")
            return (
              <div key={i}>
                <pre className="overflow-x-auto rounded-lg border border-border/60 bg-background/80 p-4 font-mono text-sm leading-relaxed">
                  <code>{b.content}</code>
                </pre>
                {b.caption && (
            ...
            {showMistake && (
              <div className="space-y-3 rounded-lg border border-border/60 bg-background/80 p-4">
                <div>
                  ...
                  <pre className="mt-1 overflow-x-auto rounded-md border border-border/50 bg-background p-3 font-mono text-xs leading-relaxed">
